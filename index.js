...
if(message.content == '괴물쥐 프로필') {
  ...
  let embed = new Discord.RichEmbed()
    .setTitle('괴물쥐 나무위키')
    .setURL('https://namu.wiki/w/%EA%B4%B4%EB%AC%BC%EC%A5%90%27')
    .setAuthor('괴물쥐', img, 'https://www.youtube.com/channel/UCDBAVzfX3yZ1hah0FHnOoaA%27')
    .setThumbnail(img)
    .addBlankField()
    .addField('본명', '장지환')
    ...
    .addField('방송 링크', '\n유튜브:https://www.youtube.com/channel/UCDBAVzfX3yZ1hah0FHnOoaA/about/n트위치:https://www.twitch.tv/tmxk319/n아프키라TV:http://bj.afreecatv.com/tmxk319/n트게더:https://tgd.kr/member/login_page?next=%2F%27')
    .addBlankField()
    .setTimestamp()
